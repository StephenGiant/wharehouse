...
public class MainPageAct extends BaseActivity {
    ...
    private String[] itemName = {"上架", "下架", "转仓上架", "转仓下架", "库存盘点", "库存查询", "第三方订单下架", "绑定货位"};
    ...
    private void initData() {
        ...
        mList.add(new MainPageTitleEntity(itemName[7]));
            ...
            public void onMyItemClick(View view, int position) {
                switch (position) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        intentTo(MainPageAct.this,GoodsWharehouseBindAct.class);
                        break;
                    default:
                        break;
